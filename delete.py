...
def trader(startDate, endDate, seedMoney, data, selectedStocks, risk):
    ...
    # print(stockTrades.groupby(['stock','date']).sum().groupby(level=0).cumsum().reset_index())
    ...
    return pd.merge(stockTrades, groupCumSum, on=['date', 'stock'])
...
trader('2018-11-19 00:00:00', '2020-11-16 00:00:00', 1000, data, ['ford', 'tesla'], 0.5).to_csv('delete2.csv')
# print(trader('2018-11-19 00:00:00', '2020-11-16 00:00:00', 1000, data, ['ford', 'tesla'], 1))
